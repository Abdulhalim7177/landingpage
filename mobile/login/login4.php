...
<link rel="apple-touch-icon" sizes="180x180" href="../../assets/img/goocr.png">
<link rel="icon" type="image/png" href="../../assets/img/goocr.png" />
<?php if(isset($_SESSION['loginId'])){echo "<script>window.location.href='../home/';</script>"; } ?>
<style>
    body{background-image:url("../../assets/img/bgg.png");  background-repeat: no-repeat; background-size: cover; height: 120vh;}
        ...
        <div class="card card-style">
            <div class="content ">
                ...
                <div class="text-center">
                    ...
                    <h4 class="font-25 mb-3 text-white" id="accountname2">Login To <?php echo strtoupper($name); ?></h4>
                </div>
                
                <div class="text-center">
                    <div class="pb-3 pt-3">
                        <img src="/assets/img/gc.png"  class="img-fluid" width="200" />
                    </div>                                    
                </div>
                ...
                <div class="px-2">
                    ...
                    <div class="row pt-5 mb-3">
                        <div class="col-12 text-center font-15">
                            <a class="text-white" href="../recovery/recovery3.php">Forget Password? Recover It</a> 
                        </div>
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-white" href="../register/">New User | Create New Account</a>
                        </div>
                        <div class="col-12 text-center font-15 mt-3">
                            <a class="text-white"<b>--- User Panel ---</b></a>
                        </div>
                    </div>
...
$("document").ready(function(){
    ...
    $('#login-form').submit(function(e){
            ...
            $('#submit-btn').html('<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> Authenticating ...');
                ...
                success:function(resp){
                    ...
                    resp = JSON.parse(resp);
                        ...
                        if(resp.status == "success"){
                            swal('Welcome Back!!',"Login Successful. You're in! Great to see you again!","success");
                            setTimeout(function(){
