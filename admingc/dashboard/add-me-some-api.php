...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <strong>Note: </strong> <br/> This is a restricted area. You need to obtain an access code to perform this operation. Before adding any link here please study the api documentation.
        </div>
    <div class="box">
